...
public class Page implements Serializable, Cloneable {
	...
	public void setLastPageNo(int l) {
		this.lastPageNo = l;
	}
	 ...
	 * @param data
	 */
	public Page(int currentPageNo, int totalRows, int pageSize, List<Object> data) {
		if (currentPageNo <=0 ) {currentPageNo = 1;};
		this.data = data;
		this.currentPageNo = currentPageNo;
		this.totalRows = totalRows;
	...
	public void setCurrentPageNo(int currentPageNo2) {
		this.currentPageNo = currentPageNo2;
	}
