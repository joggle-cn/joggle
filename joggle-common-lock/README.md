...
基于redis的分布式锁spring-boot starter组件，使得项目拥有分布式锁能力变得异常简单，
支持spring boot 等spring相关项目
...
```
<dependency>
    <artifactId>jiayu-common-lock</artifactId>
    <groupId>com.jiayu.yoga</groupId>
